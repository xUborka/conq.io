...
public class UpgradeMenuScript : MonoBehaviour
{
    ...
    {
        Display = false;
        upgrade_prices.Add(5);  // Price from 0 to 1
        upgrade_prices.Add(10); // Price from 1 to 2
        upgrade_prices.Add(15); // Price from 2 to 3
        upgrade_prices.Add(20); // Price from 3 to 4
        upgrade_prices.Add(25); // Price from 4 to 5
